...
namespace Aupli.SystemBoundaries.OperationSystem.Linux
{
    ...
    public class NetworkDeviceInfoProvider : INetworkDeviceInfoProvider
    {
        ...
        /// </summary>
        public IEnumerable<NetworkDeviceInfo> GetNetworkDevices()
        {
            ...
            var networkDevices = new List<NetworkDeviceInfo>();
            ...
            while (!ifConfigProcess.StandardOutput.EndOfStream)
            {
                ...
                if (line.Contains("inet "))
                {
                    ...
                    {
                        networkDevices.Add(new NetworkDeviceInfo(networkDeviceName, ipAddress));
