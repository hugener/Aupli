...
namespace Aupli.Bootstrapping
{
    ...
    public class ViewFactory : IViewFactory
    {
        ...
        public ViewFactory(IMusicPlayer musicPlayer, PlayerController playerController, VolumeController volumeController, VolumeService volumeService, MenuController menuController, ILifecycleConfiguration lifecycleConfiguration)
        {
            ...
            this.menuView = new Lazy<MenuTextView>(() => new MenuTextView(new NetworkDeviceProvider(), menuController));
