// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Hd44780A02EncodingExtended.cs" company="Hukano">
// Copyright (c) Hukano. All rights reserved.
// Licensed under the MIT license. See LICENSE file in the project root for full license information.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------

namespace Sundew.Pi.IO.Components.Display
{
    using System;
    ...
    /// </summary>
    public class Hd44780A02EncodingExtended : Encoding
    {
        private const byte MissingChar = 0x3F;
        private const char MissingByte = '\uFFFD';
        private static readonly Dictionary<char, byte> CharMap = Enumerable.GroupBy<KeyValuePair<char, byte>, char, byte>(GetMap(), p => p.Key, p => p.Value).ToDictionary(g => g.Key, g => g.First());
        private static readonly Dictionary<byte, char> CyteMap = Enumerable.GroupBy<KeyValuePair<char, byte>, byte, char>(GetMap(), p => p.Value, p => p.Key).ToDictionary(g => g.Key, g => g.First());

        /// <summary>
        /// Gets the supported characters.
        /// </summary>
        public static IEnumerable<char> SupportedCharacters => Enumerable.Except(CharMap.Keys, new[] { '\r', '\n' });
        ...
        public override int GetChars(byte[] bytes, int byteIndex, int byteCount, char[] chars, int charIndex)
        {
            Array.Copy(
                bytes
                    ...
                    {
                        char c;
                        return CyteMap.TryGetValue(b, out c) ? c : MissingByte;
                    })
                    .ToArray(),
                0,
                chars,
        ...
        private static IEnumerable<KeyValuePair<char, byte>> GetMap()
        {
            ...
            */
            ...
            yield return new KeyValuePair<char, byte>('Ä', 011);
            yield return new KeyValuePair<char, byte>('Å', 0xC5);
            ...
            // Variant
            yield return new KeyValuePair<char, byte>('Ç', 0xC7);
            ...
            // Variant
            yield return new KeyValuePair<char, byte>('Ñ', 0xD1);
            ...
            yield return new KeyValuePair<char, byte>('Ö', 0xD6);
            yield return new KeyValuePair<char, byte>('Ø', 0xD8);
            ...
            yield return new KeyValuePair<char, byte>('Ü', 0xDC);
            ...
            yield return new KeyValuePair<char, byte>('å', 0xE5);
            ...
            // Variant
            yield return new KeyValuePair<char, byte>('ç', 0xE7);
            ...
            // Variant
            yield return new KeyValuePair<char, byte>('ñ', 0xF1);
            ...
            yield return new KeyValuePair<char, byte>('ö', 0xF6);
            yield return new KeyValuePair<char, byte>('ø', 0xF8);
            ...
            yield return new KeyValuePair<char, byte>('ü', 0xFC);
