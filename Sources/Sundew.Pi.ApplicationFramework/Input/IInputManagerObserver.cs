// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IInputManagerObserver.cs" company="Hukano">
...
namespace Sundew.Pi.ApplicationFramework.Input
{
    ...
    public interface IInputManagerObserver
    {
        ...
        void EndedFrame(IReadOnlyList<object> inputTargets);
